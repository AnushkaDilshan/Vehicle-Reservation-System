...
import AllVehicleView from './pages/user/AllvehicleView';
import Reservationadd from './pages/user/reservation';
import UserViewreservation from './pages/user/UserViewReservation';
function App() {
  return (
    <AuthProvider>
      <Router>
        <div className="min-h-screen bg-gray-50">
          ...
          <Routes>
            <Route element={<Layout />}>
              ...
              <Route path="*" element={<HomePage/>} />
              <Route path="/user/allvehicleView" element={<AllVehicleView/>} />
              <Route path="/user/reservationadd/:id" element={<Reservationadd/>} />
              <Route path="/user/viewreservation" element={<UserViewreservation/>} />
            </Route>
          </Routes>
        </div>
      </Router>
